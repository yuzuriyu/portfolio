...
const ContactForm = () => {
  return (
    <div className="relative m-auto w-full md:w-3/4 md:pr-8">
      <div className="border-t-darkgray border-t py-8">
        <div className="mb-3 flex items-start">
          ...
          <div className="w-10/12">
            ...
            <input
              className="text-darkgray placeholder:text-darkgray w-full border-none bg-transparent text-lg focus:outline-none md:text-2xl"
              placeholder="Carl *"
            />
          </div>
        </div>
      ...
      <div className="border-t-darkgray border-b-darkgray border-b border-t py-8 pb-60">
        <div className="mb-3 flex items-start">
      ...
      <div className="absolute -bottom-20 right-8 flex h-[144px] w-[144px] items-center justify-center rounded-full bg-white md:right-16">
        <p className="font-bold">Send it!</p>
      </div>
    </div>
  );
};
